  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('Course Catalog', style: TextStyle(fontSize: 26, fontWeight: FontWeight.w800, color: AColors.ink)),
        const Text('Explore all available safety training courses', style: TextStyle(fontSize: 14, color: AColors.textMuted)),
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
            ...
            child: Center(child: Icon(cats.$3, size: 40, color: Colors.white.withValues(alpha: 0.9))),
          ),
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                Text(item.category, style: const TextStyle(
                    fontSize: 10, fontWeight: FontWeight.w700, color: AColors.textMuted, letterSpacing: 0.6)),
              ]),
              ...
              Row(children: [
                ...
                Text('${item.totalLessons} lessons', style: const TextStyle(fontSize: 11, color: AColors.textMuted)),
                const SizedBox(width: 10),
                const Icon(Icons.schedule_outlined, size: 13, color: AColors.textMuted),
                const SizedBox(width: 4),
                Text('${item.estimatedDurationMin}m', style: const TextStyle(fontSize: 11, color: AColors.textMuted)),
              ]),
            ]),
          )),
        ]),
