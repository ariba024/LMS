    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Row(children: [
        const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('Dashboard', style: TextStyle(fontSize: 26, fontWeight: FontWeight.w800, color: AColors.ink)),
          Text('Overview of your LMS', style: TextStyle(fontSize: 14, color: AColors.textMuted)),
        ])),
        AButton(
        ...
        child: items.isEmpty
            ...
            : Column(children: [
                ...
                const Padding(
                  ...
                  child: Row(children: [
                    Expanded(flex: 3, child: Text('COURSE', style: TextStyle(
                        fontSize: 11, fontWeight: FontWeight.w700, color: AColors.textMuted, letterSpacing: 0.6))),
                    Expanded(child: Text('LESSONS', style: TextStyle(
                        fontSize: 11, fontWeight: FontWeight.w700, color: AColors.textMuted, letterSpacing: 0.6))),
                    Expanded(child: Text('DURATION', style: TextStyle(
                        fontSize: 11, fontWeight: FontWeight.w700, color: AColors.textMuted, letterSpacing: 0.6))),
                    Expanded(child: Text('FORMAT', style: TextStyle(
                        fontSize: 11, fontWeight: FontWeight.w700, color: AColors.textMuted, letterSpacing: 0.6))),
                    SizedBox(width: 80),
                  ]),
                ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(children: [
          ...
          Text(label, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AColors.ink),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Center(child: Column(children: [
        ...
        const Text('No courses yet', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: AColors.ink)),
        const SizedBox(height: 6),
        const Text('Generate your first course using the Course Generator', style: TextStyle(fontSize: 13, color: AColors.textMuted)),
